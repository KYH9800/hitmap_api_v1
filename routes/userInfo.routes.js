...
router
  ...
  .get('/:userId', auth.is_logged_in_refresh_token, userInfoController.getMyPosts) // 내 게시글 조회
  .patch('/', auth.is_logged_in_refresh_token, upload.single('image'), userInfoController.updateUserInfo) // 내 정보 수정
  .delete('/', auth.is_logged_in_refresh_token, userInfoController.deleteUserAllInfo); // 회원탈퇴
