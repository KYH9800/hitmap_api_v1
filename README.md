...
|SNS 기능|1. 게시글 작성 시 이미지와 해당 게시글의 내용, 조황정보를 업로드 할 수 있다. <br> 2. 낚시를 통해 잡은 어종과 정보를 사용자들과 나눌 수 있다. <br> 3. 댓글을 통해 피드에 대한 의견을 남길 수 있다.|
|좋아요 기능|다른 사용자가 작성한 게시글이 마음에 들 경우 좋아요 표시를 할 수 있다.|
|로그인 / 회원가입|1. 영문 소문자, 숫자, 특수기호를 이용하여 아이디와 비밀번호를 설정할 수 있다. <br> 닉네임을 입력할 수 있으며, 커뮤니티를 이용하는 모든 곳엔 닉네임만 노출된다.|
|카카오 로그인|카카오 사용자는 간단하게 카카오 로그인을 진행할 수 있다.|
|회원|1. 제공되는 모든 서비스 이용이 가능하다. <br> 2. 내 정보 수정을 통해 닉네임을 변경할 수 있다.|
